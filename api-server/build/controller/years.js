...
const year = __importStar(require("../model/year/queries"));
const router = express_1.default.Router();
exports.router = router;
function handleRoute(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const years = yield year.readAll();
            loggerConf_1.logger.debug(`${__dirname}/${__filename}: ${util_1.default.inspect(years)}`);
